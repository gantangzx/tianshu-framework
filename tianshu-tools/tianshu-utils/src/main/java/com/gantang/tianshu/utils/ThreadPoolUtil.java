...
public class ThreadPoolUtil {
    ...
    private final Thread.UncaughtExceptionHandler uncaughtExceptionHandler = new DefaultUncaughtExceptionHandler();
    ...
    private ThreadPoolUtil() {
        ...
        executor = new ThreadPoolExecutor(
                ...
                new DefaultThreadFactory(Thread.NORM_PRIORITY, "thread-pool-",uncaughtExceptionHandler),
    ...
    static class DefaultThreadFactory implements ThreadFactory {
        ...
        DefaultThreadFactory(int threadPriority, String threadNamePrefix, Thread.UncaughtExceptionHandler uncaughtExceptionHandler) {
