...
import com.gantang.tianshu.exchange.common.api.reports.ApiReportQuery;
...
import com.gantang.tianshu.exchange.common.enums.BalanceAdjustmentType;
import com.gantang.tianshu.exchange.common.enums.OrderAction;
import com.gantang.tianshu.exchange.common.enums.OrderType;
import com.gantang.tianshu.exchange.orderbook.OrderBookEventsHelper;
import com.gantang.tianshu.exchange.processors.BinaryCommandsProcessor;
...
//                log.debug("seq={} cmd.size={} data={}", seq, cmd.size, cmd.price);
    ...
    private static final EventTranslatorOneArg<OrderCommand, ApiPlaceOrder> NEW_ORDER_TRANSLATOR = (cmd, seq, api) -> {
        ...
        cmd.positionAction = api.positionAction;
