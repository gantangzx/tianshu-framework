 ...
 */
package com.gantang.tianshu.exchange.common.cmd;
...
public final class OrderCommand implements IOrder {
    ...
    public static OrderCommand newOrder(OrderType orderType, long orderId, long uid, long price, long reserveBidPrice, long size, OrderAction action,PositionAction positionAction) {
        ...
        cmd.positionAction = positionAction;
...
//
    ...
    public void writeTo(OrderCommand cmd2) {
        ...
        cmd2.positionAction = this.positionAction;
    }
