...
import com.gantang.tianshu.exchange.common.StateHash;
import com.gantang.tianshu.exchange.common.api.binary.BinaryDataCommand;
import com.gantang.tianshu.exchange.common.api.reports.ReportQueriesHandler;
...
import com.gantang.tianshu.exchange.common.config.ReportsQueriesConfiguration;
import com.gantang.tianshu.exchange.orderbook.OrderBookEventsHelper;
import com.gantang.tianshu.exchange.utils.HashingUtils;
...
import static com.gantang.tianshu.exchange.common.constants.ExchangeConstant.LONGS_PER_MESSAGE;
...
public final class BinaryCommandsProcessor implements WriteBytesMarshallable, StateHash {
    ...
    public CommandResultCode acceptBinaryFrame(OrderCommand cmd) {
        log.debug("Accept Binary OrderCommand:{}",cmd);
        ...
        final TransferRecord record = incomingData.getIfAbsentPut(
                ...
                () -> {
                    ...
                    final int longArraySize = SerializationUtils.requiredLongArraySize(bytesLength, LONGS_PER_MESSAGE);
