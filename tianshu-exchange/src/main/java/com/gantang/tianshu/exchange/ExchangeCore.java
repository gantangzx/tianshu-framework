...
import com.gantang.tianshu.exchange.common.config.InitIgniteConfiguration;
import com.gantang.tianshu.exchange.common.config.PerformanceConfiguration;
import com.gantang.tianshu.exchange.common.config.SerializationConfiguration;
import com.gantang.tianshu.exchange.common.enums.CoreWaitStrategy;
import com.gantang.tianshu.exchange.orderbook.IOrderBook;
import com.gantang.tianshu.exchange.processors.*;
...
public class ExchangeCore {
    ...
    public ExchangeCore(final ObjLongConsumer<OrderCommand> resultsConsumer,
        ...
        instanceIgnite(exchangeConfiguration.getInitIgniteConfiguration());
        ...
        // 将执行的OrderCommand放入到EventHandler数组
    ...
    private void instanceIgnite(InitIgniteConfiguration igniteConfiguration) {
        if(igniteConfiguration.isIgniteEnabled()) {
            IgniteConfiguration cfg = new IgniteConfiguration();

            // The node will be started as a client node.
            cfg.setClientMode(igniteConfiguration.isClientModeEnabled());

            // Classes of custom Java logic will be transferred over the wire from this app.
            cfg.setPeerClassLoadingEnabled(igniteConfiguration.isPeerClassLoadingEnabled());

            // Setting up an IP Finder to ensure the client can locate the servers.
            TcpDiscoveryMulticastIpFinder ipFinder = new TcpDiscoveryMulticastIpFinder();
            ipFinder.setAddresses(igniteConfiguration.getAddresses());
