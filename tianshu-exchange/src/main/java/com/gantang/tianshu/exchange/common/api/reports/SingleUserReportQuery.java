...
import com.gantang.tianshu.exchange.common.Order;
import com.gantang.tianshu.exchange.common.UserProfile;
...
public final class SingleUserReportQuery implements ReportQuery<SingleUserReportResult> {
    ...
    public SingleUserReportQuery(final BytesIn<WriteBytesMarshallable> bytesIn) {
