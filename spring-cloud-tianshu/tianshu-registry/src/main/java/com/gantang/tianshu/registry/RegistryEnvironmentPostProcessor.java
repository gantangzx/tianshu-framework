...
/**
 * 将内置 {@code registry-defaults.yml} 以最低优先级加入环境，
 * 用户自身配置优先级更高，可任意覆盖。
 *
 * @author gantang
 */
public class RegistryEnvironmentPostProcessor implements EnvironmentPostProcessor {

    private static final String DEFAULTS_RESOURCE = "registry-defaults.yml";
    private static final String SOURCE_NAME = "tianshuRegistryDefaults";
