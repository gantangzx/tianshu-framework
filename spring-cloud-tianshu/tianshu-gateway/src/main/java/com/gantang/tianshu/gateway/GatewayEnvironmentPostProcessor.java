...
/**
 * 以最低优先级加载 {@code gateway-defaults.yml}，用户配置可覆盖。
 *
 * @author gantang
 */
public class GatewayEnvironmentPostProcessor implements EnvironmentPostProcessor {

    private static final String DEFAULTS_RESOURCE = "gateway-defaults.yml";
    private static final String SOURCE_NAME = "tianshuGatewayDefaults";
